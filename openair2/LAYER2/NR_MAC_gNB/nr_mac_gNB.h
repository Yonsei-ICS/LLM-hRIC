...
typedef struct gNB_MAC_INST_s {
  ...
  /// DL slice PRB policies controlled through E2SM-RC Style 2 / Action 6.
  nr_dl_slice_policy_t dl_slice_policy[MAX_NUM_SLICES];
  int dl_slice_policy_count;
  bool dl_slice_policy_enabled;
  uint64_t dl_slice_policy_prb_used[MAX_NUM_SLICES];
  frame_t dl_slice_policy_last_log_frame;
